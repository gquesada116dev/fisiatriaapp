...
export const STUDY_PLAN: PlanDay[] = [
  ...
  // Fin de semana = 3 temas (2 sáb + 1 dom ≈ 1.5/día). Trilogía de lesión medular junta.
  ...
  // Fin de semana = 3 temas (2 sáb + 1 dom). Cluster de dolor/algología.
  ...
  { date: "2026-07-04", dow: "Sáb", kind: "review", items: [{ key: "day-2026-07-04", name: "Repaso final — simulacro de examen + temas P5" }] },
